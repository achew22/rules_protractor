...
// Protractor expects the several user environment variables to be set.
process.env.NODE_ENV = process.env.NODE_ENV || 'test';
process.env.USER = process.env.USER || 'test';

console.log(process.env.REMOTE_WEBDRIVER_SERVER);
...
optimist
    ...
    .describe('seleniumServerJar',
              'Location of the standalone selenium jar file')
    .describe('seleniumPort',
